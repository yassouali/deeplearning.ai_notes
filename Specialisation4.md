...
We convolve an image of size H x W x C by a filters (F x F x W) x N_filters and we get as an output: (H-f+1) x (W-f+1) x N_filter (in case no padding and no stride)

<p align="center"> <img src="figures/conv_volume.jpg" width="400"></p>
...
<p align="center"> <img src="figures/lenet5_archi.png"></p>
...
<p align="center"> <img src="figures/alexnet.png"></p>
...
<p align="center"> <img src="figures/vgg16.png"></p>
...
<p align="center"> <img src="figures/better_per.png" width="450"></p>
...
<p align="center"> <img src="figures/3skip_conv.png" ></p>
...
Resnet network:
<p align="center"> <img src="figures/resnet.png"></p>
<p align="center"> <img src="figures/resnet2.png"></p>

#### Networks in Networks

1x1 convolutions makes sense, when the we apply a 3d filter to a volume of activations, so that each element of the output contains information extracted from all the neurons with the same spacial dimensions (x,y) but spanning over all depth of the volume.
...
The inception network contain a succesion of these blocks, ending with a fully connected layers and a softmax, in the paper they also use lateral output layers to do preditions based on the earliers layers.
...
<p align="center"> <img src="figures/withoutFC.png" ></p>
...
<p align="center"> <img src="figures/conv_sliding.png" ></p>
...
<p align="center"> <img src="figures/conv_sliding2.png" ></p>

The same thing applies for bigger images, like 28x28 image

<p align="center"> <img src="figures/conv_sliding3.png" ></p>
...
**Intersection Over Union**: = Intersection of two boxes / their union, is a way to measure how close are predicted bounding boxes (bb) to the ground truth one, IoU is used to measure the overlap between two bb, if IoU > Some threshold, like 0.5, the bb is considered correct.

<p align="center"> <img src="figures/IoU.png" width="400"></p>
...
<p align="center"> <img src="figures/box_yolo.png" width="400"></p>
...
These triplets are picked from our training dataset. We write $(A^{(i)}, P^{(i)}, N^{(i)})$ to denote the $i$-th training example. 
...
<p align="center"> <img src="figures/binary_classification.png" ></p>
...
<p align="center"> <img src="figures/viz_cnns.png" > </p>
